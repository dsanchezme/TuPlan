...
public class CreateTaskActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (isUpdating){
            ...
            priority = (String) extras.get("priority");
            sharedWith = (String) extras.get("sharedWith");
        }
        initNavBar();
        initViews();
    ...
    private void initViews(){
        ...
        if (isUpdating){
            buttonCreatePlan.setText("ACTUALIZAR PLAN");
        }else{
            buttonCreatePlan.setText("CREAR PLAN");
        }
        ...
        if (isUpdating) {
            ...
            inputStatus.setSelection(Arrays.asList(arrayStatus).indexOf(status));
            inputPriority.setSelection(Arrays.asList(arrayPriority).indexOf(priority));
        }
        ...
        groupReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(isUpdating){
                    inputSharedWith.setSelection(myGroups.indexOf(sharedWith));
                }
    ...
    private void handleClickCreation(){
        ...
        if (isUpdating){
          planDAO.addPlan(taskID, newPlan);
            mySnackbar = Snackbar.make(findViewById(R.id.LayoutCreatePlan), "Actualización exitosa", Snackbar.LENGTH_SHORT);
        } else {
